...
namespace MarvellousMarkovModels
{
    public class ModelBuilder
    {
		...
		private List<string> _seedNames = new List<string>();
        ...
        public ModelBuilder Teach(string example)
        {
			...
			_seedNames.AddExclusive(example);
        ...
        {
            return new Model(_order, Normalize(_startingStrings), _productions.ToDictionary(a => a.Key, a => Normalize(a.Value)), _seedNames);
        }
